...
Fundos de Papel: Investem em títulos de dívida ligados ao setor imobiliário, como CRI (Certificados de Recebíveis Imobiliários), LCI (Letras de Crédito Imobiliário) e LH (Letras Hipotecárias).
...
Gestão Profissional: Um gestor especializado cuida de toda a burocracia, manutenção e busca por inquilinos.
Liquidez: É muito mais fácil vender cotas de um FII na Bolsa do que vender um imóvel físico.
Isenção de Imposto de Renda: Para pessoas físicas, os dividendos mensais são isentos de IR, desde que o fundo cumpra requisitos como ter mais de 50 cotistas e ser negociado em bolsa.

Riscos
Risco de Mercado: O valor das cotas oscila diariamente na Bolsa conforme a economia e as taxas de juros (como a Selic).
Vacância: Risco de o imóvel ficar vazio e parar de gerar renda de aluguel.
...
P/VP (Preço sobre Valor Patrimonial): Indica se o fundo está caro (acima de 1) ou barato (abaixo de 1) em relação ao valor real dos seus ativos.
